...
class Tressette4Spec extends AnyFreeSpec with Matchers:
  ...
  "A game can be played" in {
    ...
    Game.playMatch[cats.Id](room1, players, messageId)(input).compile.toList shouldBe List[ServerEvent | Command | Delayed[Command]](
      ...
      shortDelay,
      CardsDealt(player3.id, List(Card(Tre, Spade), Card(Tre, Denari), Card(Asso, Coppe), Card(Fante, Bastoni), Card(Due, Denari)), Direction.Player),
      shortDelay,
      CardsDealt(player4.id, List(Card(Fante, Spade), Card(Re, Bastoni), Card(Sette, Bastoni), Card(Tre, Coppe), Card(Fante, Coppe)), Direction.Player),
      shortDelay,
      CardsDealt(player1.id, List(Card(Cinque, Bastoni), Card(Sei, Coppe), Card(Cavallo, Denari), Card(Cavallo, Bastoni), Card(Due, Coppe)), Direction.Player),
      shortDelay,
      CardsDealt(player2.id, List(Card(Fante, Denari), Card(Cavallo, Spade), Card(Quattro, Bastoni), Card(Re, Coppe), Card(Quattro, Coppe)), Direction.Player),
      shortDelay,
      CardsDealt(player3.id, List(Card(Asso, Denari), Card(Sette, Spade), Card(Cinque, Denari), Card(Sette, Coppe), Card(Re, Spade)), Direction.Player),
      shortDelay,
      CardsDealt(player4.id, List(Card(Sei, Spade), Card(Quattro, Denari), Card(Tre, Bastoni), Card(Due, Spade), Card(Cavallo, Coppe)), Direction.Player),
